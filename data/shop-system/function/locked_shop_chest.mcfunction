...
function shop-system:shop_chest/give_chest with storage shop_system:chests temp
...
scoreboard players reset @s shopChest
scoreboard players enable @s shopChest