...
$execute unless score #shopSystem shopSystem_tempChestItemCount matches $(stackSize) run return run tellraw @s {"text": "TThe items in the chest have an invalid stack size.", "color":"red"}
